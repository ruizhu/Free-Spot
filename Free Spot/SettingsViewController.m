...
- (void)viewDidLoad
{
    ...
    settingsList = [NSDictionary dictionaryWithContentsOfURL:url];
    justSettingsName = settingsList.allKeys;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = justSettingsName[indexPath.row];
